...
('GradientBoosting', 'spread', '{"mse": 100, "mae": 8, "r2": 0.1}'::jsonb, true),
('BayesianModel', 'moneyline', '{"accuracy": 0.5, "log_loss": 0.693, "brier_score": 0.25}'::jsonb, true),
('EnsembleStack', 'combined', '{"accuracy": 0.5, "mse": 100, "combined_score": 0.5}'::jsonb, true)
