...
def parse_arguments():
    ...
    parser.add_argument("--props", action="store_true", help="Include player prop predictions")
    parser.add_argument("--props-only", action="store_true", help="Show only player prop predictions")
